...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <aside
        className="group fixed left-0 top-0 h-screen w-16 hover:w-64 border-r border-gray-200 bg-white flex flex-col transition-all duration-200 ease-in-out overflow-hidden z-20"
      >
        <div className="flex items-center gap-2.5 px-4 py-5 border-b border-gray-100 min-w-64">
          ...
          <div className="flex-1 min-w-0 opacity-0 group-hover:opacity-100 transition-opacity duration-150 delay-75">
            <p className="text-sm font-semibold text-gray-900 leading-tight whitespace-nowrap">Amar Packers</p>
            ...
            >
              {({ isActive }) => (
                <>
                  <Icon
                    size={18}
                    className={clsx('shrink-0', isActive ? 'text-blue-600' : 'text-gray-400')}
                    aria-hidden="true"
                  />
        ...
        <div className="px-4 py-4 border-t border-gray-100 opacity-0 group-hover:opacity-100 transition-opacity duration-150 delay-75">
